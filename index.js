...
//
const BotName = 'ib_bot'; // Nama Bot Whatsapp
const instagramlu = 'https://instagram.com/ibnu_ws'; // Nama Instagramlu cok
const whatsapplu = '085600759983'; // Nomor whatsapplu cok
